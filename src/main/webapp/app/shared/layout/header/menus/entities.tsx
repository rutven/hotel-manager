...
export const EntitiesMenu = props => (
  ...
  <NavDropdown icon="th-list" name={translate('global.menu.entities.main')} id="entity-menu">
    ...
    <DropdownItem tag={Link} to="/entity/guest">
      <FontAwesomeIcon icon="asterisk" />&nbsp;<Translate contentKey="global.menu.entities.guest" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/reservation">
      <FontAwesomeIcon icon="asterisk" />&nbsp;<Translate contentKey="global.menu.entities.reservation" />
    </DropdownItem>
